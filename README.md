...
- `src-tauri/target/release/bundle/nsis/FastCoin_0.4.0_x64-setup.exe` — NSIS 安装包（推荐分发）
- `src-tauri/target/release/bundle/msi/FastCoin_0.4.0_x64_zh-CN.msi` — MSI 安装包（需安装 WiX Toolset v3）
